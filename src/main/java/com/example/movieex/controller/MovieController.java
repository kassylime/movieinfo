package com.example.movieex.controller;

import com.example.movieex.entity.Movie;
import com.example.movieex.service.MovieService;
...
public class MovieController {
    ...
    public String updareProc(@RequestPart List<MultipartFile> files, Movie movie, HttpSession session, RedirectAttributes rttr){
        log.info("updateProc()");
